...
const keys = [
  ...
  '5b1a53fd-1e3c-4a3b-ba12-1608f4e74ff1:fdc5e07aa0fcc314647f79faeb1b260c46deba56506f2a4a622cc4915b9759ae'
];
...
async function testKey(key) {
  ...
  return new Promise((resolve) => {
    const req = https.request({
      hostname: 'fal.run',
      path: '/fal-ai/flux-pro', // Simpler endpoint for testing
      method: 'POST',
      headers: {
